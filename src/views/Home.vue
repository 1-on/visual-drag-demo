...
export default {
    components: { componentDataImport, 
    ...
    methods: {
        ...
        handleDrop(e) {
            ...
            const dragData = e.dataTransfer.getData('dragData')
            ...
            if (index) {
                ...
                if (type === '0') {
                    ...
                    component = deepCopy(componentDataImport[index])
                } else if (type === '2') {
                    component = deepCopy(componentPreProcessing[index])
                } else if (type === '3') {
                    component = deepCopy(componentFeatureEngineer[index])
                } else if (type === '4') {
                    component = deepCopy(componentModelSelection[index])
                } else if (type === '5') {
                    component = deepCopy(componentModelEvaluation[index])
                }
...
@/custom-component/component-DataImport